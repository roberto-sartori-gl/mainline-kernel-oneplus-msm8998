...
#define DMA_MASK \
	(BIT(DPU_SSPP_SRC) | BIT(DPU_SSPP_QOS) | BIT(DPU_SSPP_TS_PREFILL) |\
	BIT(DPU_SSPP_CDP) | BIT(DPU_SSPP_EXCL_RECT))

#define DMA_MSM8998_MASK \
	(DMA_MASK | BIT(DPU_SSPP_TS_PREFILL_REC1))

#define DMA_SDM845_MASK \
	(DMA_MASK | BIT(DPU_SSPP_TS_PREFILL_REC1) | BIT(DPU_SSPP_QOS_8LVL))
